...
public class Data {
    ...
    public static String HOST_PRODUCT_SELLER = HOST_PRODUCT + "vendedor/"; //+"comprador/";
    public static String HOST_FAVORITO = HOST + "/usuariosfavoritos";
    public static String HOST_CITAS = HOST + "/citas";
    public static String HOST_MENSAJE = HOST + "/mensaje";
